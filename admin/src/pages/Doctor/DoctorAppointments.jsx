  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      ...
      <div className='bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded text-sm max-h-[80vh] overflow-y-scroll transition-colors'>
        <div className='max-sm:hidden grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 py-3 px-6 border-b border-gray-200 dark:border-slate-700 text-gray-600 dark:text-slate-400'>
          <p>#</p>
          <p>Patient</p>
          <p>Payment</p>
          <p>Age</p>
        ...
        {appointments.map((item, index) => (
          <div className='flex flex-wrap justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[0.5fr_2fr_1fr_1fr_3fr_1fr_1fr] gap-1 items-center text-gray-500 dark:text-slate-400 py-3 px-6 border-b border-gray-200 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors' key={index}>
